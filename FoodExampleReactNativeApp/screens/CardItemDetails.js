  ...
  return (<View style={styles.container}>
    ...
    <HeaderImageScrollView 
        ...
        <TriggeringView
          ...
          onHide={() => {console.log("pasa2");navTitleView.current.fadeInUp(200)}}
          onDisplay={() => {console.log("pasa2");navTitleView.current.fadeOut(100)}}>
        ...
        <View style={[styles.section, {height: 250}]}>
          <MapView
            ...
            region={{
              ...
              latitudeDelta: 0.00064195044303443,
              longitudeDelta: 0.008142817690068,
            }}>
            <Marker
